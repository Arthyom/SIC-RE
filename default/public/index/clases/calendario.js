...
var titleColor="#9ccd08";
var daysColor="#e2f358";
var bodyColor="#e2f358";
var dayColor="#eefbd1";
var currentDayColor="#9ccd08";
var footColor="#e2f358";
var borderColor="#436d23";

var titleFontColor = "#436d23";
var daysFontColor = "#436d23";
var dayFontColor = "#436d23";
var currentDayFontColor = "#436d23";
var footFontColor = "#436d23";
...
var yxMonths=new Array("Enero", "Febrero", "Marzo", "Abril", "Mayo", "Junio", "Julio", "Agosto", "Septimbre", "Octubre", "Noviembre", "Diciembre");
...
function showCal(name) {
  ...
  if (currentCal != null && currentCal.form != null && currentCal.form[currentCal.field]) {
    ...
    if (currentCal == null) {
      window.status = "Calendario ["+name+"] no existe.";
    }
    else if (!currentCal.form) {
      window.status = "Form ["+currentCal.formName+"] no existe.";
    }
    else if (!currentCal.form[currentCal.field]) {
      window.status = "El campo del Form ["+currentCal.formName+"."+currentCal.field+"] no existe.";
    }
